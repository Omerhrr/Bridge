...
import { ref } from 'vue'
import { Copy, Check, PhoneCall, BrainCircuit, ShieldCheck } from 'lucide-vue-next'
...
<template>
  <div>
    <div class="mb-5">
      ...
      <p class="text-sm text-muted mt-0.5">Provider configuration status — credentials stay in environment variables, never in workflows</p>
    </div>
